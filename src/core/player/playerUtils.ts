...
const statusThresholds: Record<keyof ModStats, Array<{ minPercent: number; message: string }>> = {
  Bladder: [
    ...
    { minPercent: 20, message: "%NAME%'s bladder feels a tiny bit full" },
  ...
  Bowel: [
    { minPercent: 0, message: "" },
    { minPercent: 20, message: "%NAME%'s bowels feel a tiny bit full" },
  ...
  Incontinence: [
    { minPercent: 0, message: "%NAME% feels in complete control" },
    { minPercent: 20, message: "%NAME% feels a bit in control" },
    { minPercent: 40, message: "%NAME% feels a bit weak" },
    { minPercent: 70, message: "%NAME% is struggling to hold it" },
    { minPercent: 80, message: "%NAME% has almost no control left" },
    { minPercent: 90, message: "%NAME% has lost all control" },
  ],
  MentalRegression: [
    { minPercent: 0, message: "%NAME%'s mind feels clear" },
    { minPercent: 40, message: "%NAME%'s mind feels a bit foggy" },
    { minPercent: 70, message: "%NAME% feels very childlike" },
  ...
  PuddleSize: [
    ...
    { minPercent: 60, message: "%NAME% feels a noticeable puddle forming at %POSSESSIVE% feet" },
    { minPercent: 80, message: "%NAME% feels a large puddle forming at %POSSESSIVE% feet" },
  ],
  WaterIntake: [],
  FoodIntake: [],
  MinigameStatistics: [],
