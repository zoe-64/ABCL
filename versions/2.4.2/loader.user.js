...
// @icon  https://zoe-64.github.io/ABCL/versions/2.4.2/assets/favicon.ico
// @grant none
// @run-at document-end
// ==/UserScript==
...
(function () {
  "use strict";
  const src = `https://zoe-64.github.io/ABCL/versions/2.4.2/abcl.js?v=${Date.now()}`;
  // @ts-ignore
